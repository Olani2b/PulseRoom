...
<html>
    ...
    <title>PulseRoom | Dashboard</title>
        ...
        <link rel="stylesheet" href="./Frontend/css/lyrics.css">
...
<body>
    ...
    <div class="w3-main bgimg-1" id="mainContent">    
        <!-- Library: tracks (MP3) and lyrics (TXT) -->
        <div id="catalogueSection" class="w3-section">
            <div class="w3-center w3-padding-64">
                <div class="w3-center w3-text-black w3-margin-top">
                    <span class="w3-xxxlarge w3-hide-small w3-animate-bottom">Library</span>
                    <br>
                    <span class="w3-xxlarge w3-hide-large w3-hide-medium w3-animate-bottom">Library</span>
                    <br>
                </div>
                <div class="w3-left-align w3-margin-left w3-section w3-bottombar w3-padding-16 w3-margin-bottom w3-animate-bottom">
                    ...
                    <button class="w3-button w3-black" id="mp3FilterBtn"><i class="fa fa-file-audio-o w3-margin-right"></i>MP3</button>
                    <button class="w3-button w3-black" id="txtBtn"><i class="fa fa-file-text-o w3-margin-right"></i>Lyrics (TXT)</button>
                </div>
        ...
        <div id="uploadFileSection" class=" w3-section w3-hide w3-margin-left">
            <div class="w3-display-topmiddle w3-text-black" >
                <div class="w3-margin-top w3-padding-top-64">
                    <span class="w3-xxxlarge w3-hide-small w3-animate-bottom">Upload music content</span>
                    <br>
                    <span class="w3-xxlarge w3-hide-large w3-hide-medium w3-animate-bottom">Upload music content</span>
                    <br>
                </div>
                <form id="uploadForm" class="w3-animate-bottom">
                    ...
                    <div class="overlap-container">
                        <div id="file_upload_section">
                            <label id="title_label" for="title"><b>Song title</b></label>
                            <input type="text" class="w3-input w3-border" name="title" id="title" placeholder="Required for lyrics. If left blank with MP3 only, the filename is used.">
                            <br>
                            <label id="upload_file_label" for="file"><b>Select your MP3 file (optional, Max Size: 5MB)</b></label>
                            <input type="file" class="w3-input w3-border" name="upload_file" id="file" accept=".mp3,audio/mpeg">
                            <br>
                        </div>
                        <div id="text_upload_section">
                            <label id="text_content_label" for="text_content"><b>Insert your lyrics (optional)</b></label>
                            <textarea class="w3-input w3-border textarea-max-height" name="text_content" id="text_content" rows="6" cols="150"></textarea>
                            <br>
                        </div>
                    
                        <input type="radio" name="track-visibility" id="track-visibility-free" value="free" class="w3-radio">
                        <span class="w3-medium"><b>Free</b></span>
                        <input type="radio" name="track-visibility" id="track-visibility-pro" value="pro" class="w3-radio">
